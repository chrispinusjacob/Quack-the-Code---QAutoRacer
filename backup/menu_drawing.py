...
# Draw main menu
def draw_main_menu(screen, buttons, game_time, get_font):
    # Fill background
    screen.fill((0, 0, 0))
    ...
    tip_surf = tip_font.render(tip_text, True, (0, 255, 255))  # NEON_CYAN
    screen.blit(tip_surf, 
               (SCREEN_WIDTH // 2 - tip_surf.get_width() // 2, 
                SCREEN_HEIGHT - 50))

# Draw pause menu
def draw_pause_menu(screen, buttons, get_font):
...
def draw_settings_screen(screen, get_font):
    # Fill background
    screen.fill((0, 0, 0))
...
def draw_high_scores_screen(screen, get_font):
    # Fill background
    screen.fill((0, 0, 0))
    ...
    for i, score in enumerate(high_scores):
        ...
        score_surf = font.render(score_text, True, (0, 255, 255))  # NEON_CYAN
...
def draw_instructions_screen(screen, get_font):
    # Fill background
    screen.fill((0, 0, 0))
